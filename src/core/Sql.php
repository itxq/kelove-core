...
class Sql extends SingleModel
{
     ...
     * @return mixed
     */
    public function getSqlFromFile($sqlFile = '', $string = false, $replace = []) {
        ...
        // 分割语句
        $handle = $this->parseSql($handle, $string, $replace);
        return $handle;
    }
     ...
     */
    public function parseSql($content = '', $string = false, $replace = []) {
        // 被替换的内容
